...
```bash
git remote add encore encore://pure-living-pro-4mhi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/pure-living-pro-4mhi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/pure-living-pro-4mhi/settings/integrations/github)
