...
export function OverviewDashboard() {
  ...
  const { data: affiliateStats, isLoading: affiliateLoading, error: affiliateError } = useAffiliateStats();
  const { data: articles, error: articlesError } = useContentList({ limit: 1 });
  const { data: weeklyReport, error: weeklyReportError } = useWeeklyReport();
  const { data: revenueAnalysis, error: revenueError } = useRevenueAnalysis();
  ...
  return (
    <AdminErrorBoundary context="Overview Dashboard">
      <div className="space-y-8">
        ...
        {/* Revenue Progress */}
        <AdminErrorBoundary context="Revenue Progress" fallback={
          <AdminErrorFallback context="Revenue Progress" />
        }>
        ...
        {/* KPIs */}
        <AdminErrorBoundary context="KPI Cards" fallback={
          <AdminErrorFallback context="KPI Metrics" />
        }>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Quick Actions */}
          <AdminErrorBoundary context="Quick Actions">
          ...
          {/* AI Recommendations */}
          <AdminErrorBoundary context="AI Recommendations" fallback={
            <AdminErrorFallback context="AI Recommendations" error={weeklyReportError} />
          }>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Top Products */}
          <AdminErrorBoundary context="Top Products" fallback={
            <AdminErrorFallback context="Top Products" error={revenueError} />
          }>
          ...
          {/* Automation Status */}
          <AdminErrorBoundary context="Automation Status">
            <Card className="border-0 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-green-50 to-lime-50 rounded-t-xl">
